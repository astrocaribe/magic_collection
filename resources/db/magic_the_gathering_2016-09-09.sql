...
# Generation Time: 2016-09-09 23:47:44 +0000
# ************************************************************
...
VALUES
	(1,'Press For Answers',1,2,'Sorcery',NULL,'Tap target creature. It doesn\'t untap during its controller\'s next untap step.\n\nInvestigate. (Put a colorless Clue artifact token onto the battlefield with \"2, Sacrifice this artifact: Draw a card.\")','','Shadows Over Innistrad',NULL,NULL,'Common',1,'80'),
	(2,'Inquisitor\'s Ox',3,4,'Creature','Ox','Delurium - Inquisitor\'s Ox gets +1/+0 and has vigilance as long as there are four or more card types among cards in your graveyard.','Many fields now lie fallow in Gavony, as the oxen have been confiscated to perform other duties.','Shadows Over Innistrad',2,5,'Common',1,'24'),
	(3,'Just The Wind',1,2,'Instant',NULL,'Return target creature to it\'s owner\'s hand.\n\nMadness (Blue card) (If you discard this card, discard it into exile. When you do, cast it for its madness cost or put it into your graveyard.)','\"There is nothing to worry about.\"','Shadows Over Innistrad',NULL,NULL,'Common',1,'71'),
	(4,'Apothecary Geist',3,4,'Creature','Spirit','Flying\n\nWhen Apothecary Geist enters the battlefield, if you control another Spirit, you gain 3 life.','For some customers, the old apothecary shop still opens its doors.','Shadows Over Innistrad',2,3,'Common',1,'4'),
	(5,'Ghoulcaller\'s Accomplice',1,2,'Creature','Human Rouge','3 {Black}, Exile Ghoulcaller\'s Accomplice from your graveyard: Put a 2/2 black Zombie creature token onto the battlefield. Activate this ability only any time you could cast a sorcery.','\"Once in the box, we\'re all the same.\"','Shadows Over Innistrad',2,2,'Common',1,'112'),
	(6,'Kessig Dire Swine',4,6,'Creature','Boar Horror','Delirium - Kessig Dire Swine has trample as long as there are four or more card types among cards in your graveyard.','In the quiet of the Somberwald, new horrors stir.','Shadows Over Innistrad',6,6,'Common',1,'214'),
	(7,'Dead Weight',0,1,'Enchantment','Aura','Enchantment Creature\n\nEnchanted Creature gets -2/-2.','\"Dungeons and cages offer far too little sport.\"\n- Relio Voldaren','Shadows Over Innistrad',NULL,NULL,'Common',1,'106'),
	(8,'Ember-Eye Wolf',1,2,'Creature','Wolf','Haste\n\n1 {Red}: Ember-Eye Wolf gets +2/+0 until end of turn.','No howl. No snarl. Just the roar of flames.','Shadows Over Innistrad',1,2,'Common',1,'154'),
	(9,'Equestrian Skill',3,4,'Enchantment','Aura','Enchant Creature\n\nEnchanted creature gets +3/+3.\n\nAs long as enchanted creature is a Human, it has trample.','From the jagged peaks of Stensia, to the tangled woods of Kessig, to the bogs of Nephalia, the Gavony Riders prepare for all terrain.\n','Shadows Over Innistrad',NULL,NULL,'Common',1,'204'),
	(10,'Gisa\'s Bidding',2,4,'Sorcery',NULL,'Madness 2 {Black} (If you discard this cars, discard it into exile. When you do, cast it fo its madness cost or put in into your graveyard.)','\"Sotf dirt makes for light work.\"','Shadows Over Innistrad',NULL,NULL,'Uncommon',1,'114'),
	(11,'Trail Of Evidence',2,3,'Enchantment',NULL,'Whenever you cast an instant or sorcery spell, investigate. (Put a colorless Clue artifact token onto the battlefield with \"2, Sacrifice this artifact: Draw a card.\")','\"Every answer seems to lead to a more terrifying question.\"\n- Jace Beledren','Shadows Over Innistrad',NULL,NULL,'Uncommon',1,'93'),
	(12,'Biting Rain',2,4,'Sorcery',NULL,'All creatures get -2/-2 until end of turn.\n\nMadness 2 Black (If you discard this card, discard it into exile. When you do, cast it for its madness cost or put it into your graveyard.)','On Innistrad, it is seldom wrong to stay indoors.','Shadows Over Innistrad',NULL,NULL,'Uncommon',1,'102'),
	...
	(17,'Niblis Of Dusk',2,3,'Creature','Spirit','Flying\n\nProwess (Whenever you cast a noncreature spell, this creature gets +1/+1 until end of turn.)','It fuels its lanterns by leaching the warmth from its surroundings.','Shadows Over Innistrad',2,1,'Common',1,'76'),
	(18,'Unruly Mob',1,2,'Creature','Human','Whenever aother creature you control dies, put a +1/+1 counter on Unruly Mob.','\"Those who aren\'t welcome will know it!\"\n- Kolman, elder of Gatstaf','Shadows Over Innistrad',1,1,'Common',1,'47'),
	(19,'Pieces Of The Puzzle',2,3,'Sorcery',NULL,'Reveal the top five cards of your library. Put up to two instant and/or sorcery cards from among them into your hand and the rest into your graveyard.','\"The clues have begun to reveal a truth I hesitate to accept.\"','Shadows Over Innistrad',NULL,NULL,'Common',1,'78'),
	(20,'Sanitarium Skeleton',0,1,'Creature','Skeleton','2 {Black}: Return Sanitarium Skeleton from your graveyard to your hand.','His mind was lost long before his flesh.','Shadows Over Innistrad',1,2,'Common',1,'133'),
	(21,'Moorland Drifter',1,2,'Creature','Spirit','Delirium - Moorland Drifter has flying as long as there are four or more card types among cards in you graveyard.','It has no apparent purpose or direction. It simply drifts, buoyed by breezes both tangible and otherworldy.','Shadows Over Innistrad',2,2,'Common',1,'27'),
	(22,'Root Out',2,3,'Sorcery',NULL,'Destroy target artifact or enchantment.\n\nInvestigate. (Put a colorless Clue artifact token onto the battlefield with \"2, Sacrifice this artifact: Draw a card.\")','','Shadows Over Innistrad',NULL,NULL,'Common',1,'224'),
	(23,'Rottenheart Ghoul',3,4,'Creature','Zombie','When Rottenheart Ghoul dies, target player discards a card.','\"To die failing to save a loved one is just so sad - or, more to the point, pathetic.\"\n- Liliana Vess','Shadows Over Innistrad',2,4,'Common',1,'132'),
	(24,'Reduce to Ashes',4,5,'Sorcery',NULL,'Reduce Tot Ashes deals 5 damage to target creature. If that creature would die this turn, exile it instead.','Previously the training center for the cathars, the Elgaud Grounds are now used by the Lunarch Inquisition to punish those considered to be heretics.','Shadows Over Innistrad',NULL,NULL,'Common',1,'176'),
	(25,'Rabid Bite',1,2,'Sorcery',NULL,'Target creature you control deals damage equal to its power to target creature you don\'t control.','\"You should have seen the look on both their faces.\"\n- Morkamp, Lambholt inkeeper','Shadows Over Innistrad',NULL,NULL,'Common',1,'223'),
	(26,'Reaper of Flight Moonsilver',3,5,'Creature','Angel','Flying\n\nDelirium - Sacrifice another creature: Reper of Flight Moonsilver gets +2/+1 until the end of turn. Activate this ability only if there are four or more card types among cards in your graveyard.','','Shadows Over Innistrad',3,3,'Uncommon',1,'36'),
	(27,'Rise from the Tides',5,6,'Sorcery',NULL,'Put a 2/2 black Zombie creature token onto the battlefield tapped for each instant and socery card in your graveyard.','\"Dear brother, it\'s sweet that you have chosen to share your tous with Ludevic, but I too have found some new playmates.\"\n- Ghoulcaller Gisa','Shadows Over Innistrad',NULL,NULL,'Uncommon',1,'83'),
	...
	(29,'Avacyn\'s Judgement',1,2,'Sorcery',NULL,'Madness X {Red} (If you discard this card, discard it into exile. When you do, cast it for its madness cost or out it into your graveyard.)\n\nAvacyn\'s Judgement deals 2 damage divided as you choose among any number of target creatures and/or players. If Avacyn\'s Judgement\'s madness cost was paid, it deals X damage divided as you choose among those creatures and/or players instead.','','Shadows Over Innistrad',NULL,NULL,'Rare',1,'145'),
	(30,'Gatstaf Arsonists - DFC',4,5,'Creature','Human Werewolf','At the beginning of each upkeep, if no spells were cast last turn, transform Gatstaf Arsonists.','The glow in their eyes reveals more than anger or madness.','Shadows Over Innistrad',5,4,'Common',1,'158a'),
